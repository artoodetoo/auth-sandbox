...
class OAuth2Client
{
    ...
    public $curl_header = [];
    public $curl_useragent = "OAuth/2 Simple PHP Client v0.1";
            ...
            if ($this->token_info_url && $this->refresh_token) {
                ...
                if ($tokeninfo && isset($tokeninfo->error)) {
                    ...
                    if (!isset($response->access_token) || !$response->access_token) {
                        throw new Exception(
                            "The Authorization Service has return an invalid response while requesting "
                            ."a new access token. given up!"
                        );
                    }
