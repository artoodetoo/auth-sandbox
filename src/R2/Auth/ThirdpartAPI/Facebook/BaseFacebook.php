...
namespace R2\Auth\ThirdpartAPI\Facebook;
...
abstract class BaseFacebook
{
    ...
    protected function _restserver($params)
    {
        ...
        $result = json_decode(
            $this->_oauthRequest($this->getApiUrl($params['method']), $params),
            true
        );
    ...
    protected function _graph($path, $method = 'GET', $params = [])
    {
        ...
        $result = json_decode(
            $this->_oauthRequest($this->getUrl($domainKey, $path), $params),
            true
        );
    ...
    protected function makeRequest($url, $params, $ch = null)
    {
        ...
        if ($errno == 60 || $errno == 77) {
            ...
            curl_setopt($ch, __DIR__.'/Resources/fb_ca_chain_bundle.crt');
            $result = curl_exec($ch);
        }
